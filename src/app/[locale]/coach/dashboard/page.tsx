...
export default function CoachDashboard() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'PENDING':
        return <span className={styles.statusPending}>⏳ Pending Approval</span>;
      case 'REJECTED':
        ...
        <div className={styles.hero}>
          <div className={styles.heroContent}>
            ...
            <p className={styles.subtitle}>
              Manage your coaching sessions and connect with your clients
            </p>
          </div>
        </div>
            ...
            <div className={styles.alertSection}>
              {profile.status === 'PENDING' && (
                <div className={styles.alertPending}>
                  ...
                  <div className={styles.alertContent}>
                    <h3 className={styles.alertTitle}>Account Pending Approval</h3>
                    <p className={styles.alertText}>
                      Your coach application is currently under review. You'll be notified once an admin approves your profile.
                      In the meantime, you can update your profile information and prepare for your coaching journey!
                    </p>
                  </div>
                </div>
              )}
              {profile.status === 'REJECTED' && (
                <div className={styles.alertRejected}>
                  <div className={styles.alertIcon}>✗</div>
                  <div className={styles.alertContent}>
                    <h3 className={styles.alertTitle}>Application Not Approved</h3>
                    <p className={styles.alertText}>
                      Unfortunately, your coach application was not approved. Please contact support for more information
                      or to resubmit your application with updated credentials.
                    </p>
                    <Link href="/contact">
              ...
              <div className={styles.profileCard}>
                <div className={styles.profileHeader}>
                  ...
                  <div className={styles.profileInfo}>
                    <h3 className={styles.profileName}>{user?.name || 'Coach'}</h3>
                    <p className={styles.profileDiscipline}>{profile.discipline}</p>
